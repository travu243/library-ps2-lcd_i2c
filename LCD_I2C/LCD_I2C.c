...
- Khoi tao bien LCD: LCD_I2C lcd;
- Khoi tao LCD: LCD_I2C_Init(&lcd,&hi2c1,0x4e,20,4);
- Su dung cac ham phai truyen dia chi cua LCD: 
LCD_I2C_SetCursor(&lcd, 0, 1);
LCD_I2C_WriteString(&lcd,"dau buoi");
******************************************************************************************************************/
#include "LCD_I2C.h"
...
static void LCD_WriteI2C(LCD_I2C *LCD, uint8_t Data, uint8_t Mode)
{
	char Data_H;
	char Data_L;
	uint8_t Data_I2C[4];
